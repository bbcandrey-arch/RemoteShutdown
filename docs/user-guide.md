...
<img src="images/pairing.png" alt="Экран подключения к ПК" width="280"> <img src="images/pin.png" alt="Экран ввода PIN" width="280">
...
запуске. Значок «?» в правом верхнем углу экрана подключения открывает эту же
справку прямо в приложении:

<img src="images/help-dialog.png" alt="Экран справки в приложении" width="280">

## Возможности приложения

<img src="images/dashboard-top.png" alt="Дашборд: основные действия и таймеры" width="280"> <img src="images/dashboard-bottom.png" alt="Дашборд: громкость, медиа, активные задачи" width="280">

**Основные действия** — выключение (крупная кнопка), перезагрузка, сон,
гибернация, блокировка экрана. Опасные команды всегда просят подтверждения:

<img src="images/confirm-dialog.png" alt="Диалог подтверждения выключения" width="280">

**Таймеры выключения** — быстрые пресеты (15/30/60 мин, 1.5/2/3 часа) и кнопка
«Своё время» — выбор конкретного часа через системный выбор времени:

<img src="images/custom-time.png" alt="Выбор своего времени для таймера" width="280">

Активные таймеры видны внизу дашборда, их можно отменить или отложить на
10 минут.
...
<img src="images/touchpad.png" alt="Экран тачпада" width="280">

**Несколько ПК** — иконка «Мои ПК» в шапке дашборда: можно сопрячь телефон с
несколькими компьютерами и переключаться между ними. Меню дашборда (⋮) —
переименование, отвязка, справка, версия приложения:

<img src="images/dashboard-menu.png" alt="Меню дашборда" width="280"> <img src="images/pc-list.png" alt="Список сопряжённых ПК" width="280"> <img src="images/about.png" alt="Диалог О приложении" width="280">
